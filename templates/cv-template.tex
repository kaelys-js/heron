...
% Bullet markers — use \textbullet rather than the math-mode
% \vcenter{\hbox{\tiny$\bullet$}} hack the upstream template shipped with.
% Some ATS parsers extract math-wrapped glyphs as garbage characters; plain
% \textbullet is rendered the same visually but lives in the text layer as
% U+2022, which pdftotext and every ATS handles cleanly.
