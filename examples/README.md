...
| `profile.example.yml` | The canonical profile schema — copy to `config/profile.yml` and fill in your details |
...
4. Copy `profile.example.yml` → `config/profile.yml` and edit.
