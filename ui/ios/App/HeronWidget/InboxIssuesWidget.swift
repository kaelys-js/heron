...
struct InboxProvider: TimelineProvider {
    ...
    func placeholder(in _: Context) -> InboxEntry {
    ...
    func getSnapshot(in _: Context, completion: @escaping (InboxEntry) -> Void) {
    ...
    func getTimeline(in _: Context, completion: @escaping (Timeline<InboxEntry>) -> Void) {
