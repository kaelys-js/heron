...
final class WatchModel: NSObject, ObservableObject, WCSessionDelegate {
    ...
    /// branding/brand.json). Previously hardcoded as a literal App Group
    /// id, which would silently drift on rebrand — the host app would write
    ...
    private func decode<T: Decodable>(_: T.Type, from dict: [String: Any]) -> T? {
