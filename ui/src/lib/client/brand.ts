...
export const BRAND = {
  ...
  voice: {
    "$comment": "Brand voice as data — used by .md templates in branding/_templates/. The narrative .md files (BRAND.md, VOICE.md, COLORS.md, TYPOGRAPHY.md, MASCOT.md, README-banner.md, SOCIAL-CARD.md, PRESS.md) are GENERATED by apply-brand from these templates + the values here.",
    "tagline": "Stand still. Strike well.",
