...
export const NON_COMP_ASKS: NonCompAsk[] = [
  ...
  {
    category: 'Level',
    ask: 'Senior → Staff title bump (with corresponding equity refresh)',
    why: 'Title compounds — every future role uses this as the floor. Worth 20-30% comp.',
    difficulty: 3,
  },
  {
    category: 'Level',
    ask: 'Confirm leveling matches stated scope (e.g. Senior at this co = Staff elsewhere)',
    why: 'External leveling varies wildly — protect yourself from "Senior" that\'s really Mid.',
    difficulty: 1,
  },
  ...
  {
    category: 'Comp',
    ask: 'Signing bonus to bridge any base gap (1-3× monthly base)',
    why: "Doesn't affect the salary band, often available when base isn't.",
    difficulty: 2,
  },
  {
    category: 'Comp',
    ask: 'Year-1 equity refresh accelerator',
    why: 'Most refreshes start Year-2. Asking for Year-1 unlocks ~25% more 4-year equity.',
    difficulty: 2,
  },
  {
    category: 'Comp',
    ask: 'Double-trigger acceleration on change-of-control',
    why: "If they're acquired in Y1-2, you keep your unvested equity instead of being trapped.",
    difficulty: 3,
  },
  {
    category: 'Comp',
    ask: 'Annual equity refresh % minimum (written into offer)',
    why: 'Most refreshes are discretionary. Locking in a floor protects against future cuts.',
    difficulty: 3,
  },
  ...
  {
    category: 'Remote',
    ask: 'Confirm remote eligibility in writing (NOT just verbally)',
    why: 'Remote policies shift. Written = enforceable. Verbal = "we never agreed to that."',
    difficulty: 1,
  },
  {
    category: 'Remote',
    ask: 'Travel cap / quarterly offsite commitment',
    why: 'Define expectations upfront — avoid surprise mandatory office days.',
    difficulty: 1,
  },
  {
    category: 'Remote',
    ask: 'Home office stipend ($500-$2000 one-time + monthly internet)',
    why: 'Most companies have this; you have to ask.',
    difficulty: 1,
  },
  ...
  {
    category: 'Start',
    ask: 'Push start date out 4-6 weeks beyond their default',
    why: 'Time off between jobs is wildly underrated. Recovery + bandwidth for the new role.',
    difficulty: 2,
  },
  {
    category: 'Schedule',
    ask: 'Pre-approved Week 1 PTO for already-planned travel',
    why: 'Easier to ask BEFORE signing than to grovel month 1.',
    difficulty: 1,
  },
  {
    category: 'PTO',
    ask: 'Extra week of PTO (negotiable when "unlimited" isn\'t cultural)',
    why: 'Hardline PTO numbers (15 vs 20 days) bend more than equity.',
    difficulty: 2,
  },
  ...
  {
    category: 'Growth',
    ask: 'Annual learning / conference budget ($2K-$5K)',
    why: "Standard at Senior+ at most tech cos. If they don't offer it, you ask.",
    difficulty: 1,
  },
  {
    category: 'Growth',
    ask: 'Documented promotion criteria for Year-1 promotion target',
    why: 'Locks in a real ladder, not "we\'ll see how it goes."',
    difficulty: 3,
  },
  ...
  {
    category: 'IP',
    ask: 'Carve-out for existing open-source + side projects (IP assignment)',
    why: 'Default IP assignment is overly broad. Carve out before signing or you legally own nothing you build on the side.',
    difficulty: 1,
  },
];
...
export const DEFAULT_TIER_COMP_BANDS: Record<string, CompBand> = {
  'faang-senior': {
    ...
    notes:
      'Base + RSU + bonus. Higher in NYC/SF; lower remote. Use levels.fyi for company-specific.',
  },
  'faang-staff': {
    band: 'FAANG Staff (L6)',
  ...
  'remote-senior': {
    ...
    notes:
      'Remote bands compress geographic spread. GitLab, Buffer, Doist publish theirs publicly.',
  },
};
