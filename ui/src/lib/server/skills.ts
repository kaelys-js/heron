...
const EMOJI: Record<string, string> = {
  ...
  'reference-prep': '👥', 'drill-feedback': '💻', 'interview-prep': '🎤', 'mock-interview': '🎭', 'mock-interview-turn': '🗣️', 'interview-retro': '📝', 'pre-call-dossier': '📂', 'seed-story-bank': '🌱', 'tech-prep': '🧪', 'seed-form-answers': '📋',
  pdf: '📄', latex: '📐',
