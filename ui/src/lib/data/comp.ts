...
export const TARGET_RANGE_OPTIONS: CompOption[] = [
  { value: '$60K-$90K', label: '$60K–$90K', description: 'Junior / Associate · entry into the industry' },
  { value: '$90K-$140K', label: '$90K–$140K', description: 'Mid · 3–5 yrs of focused experience' },
  { value: '$120K-$180K', label: '$120K–$180K', description: 'Senior · 5+ yrs · ICs leading single tracks' },
  { value: '$170K-$240K', label: '$170K–$240K', description: 'Staff · 8+ yrs · cross-team scope' },
  { value: '$220K-$320K', label: '$220K–$320K', description: 'Senior Staff · org-wide scope · principal-track' },
  { value: '$300K-$450K', label: '$300K–$450K', description: 'Principal · industry-recognised expertise' },
  { value: '$400K+', label: '$400K+', description: 'Distinguished / Sr. Principal · public-company exec band' },
];
...
export const WALKAWAY_OPTIONS: CompOption[] = [
  ...
  { value: '$100K USD', label: '$100K', description: 'Mid · standard floor in major US tech metros' },
  ...
  { value: '$180K USD', label: '$180K', description: 'Staff · typical floor for senior staff IC roles' },
  { value: '$220K USD', label: '$220K', description: 'Staff+ · principal-track minimum' },
  { value: '$280K USD', label: '$280K', description: 'Principal · public-company senior-leadership floor' },
];
