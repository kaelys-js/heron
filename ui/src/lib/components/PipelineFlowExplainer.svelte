    ...
    <div class="overflow-hidden min-h-0">
      <div class="px-4 pb-4 pt-1 space-y-3 border-t border-border/40">
        <p class="text-[11px] text-muted-foreground leading-relaxed pt-2">
          Open any job, then change <span class="font-medium text-foreground"
        ...
        <div
          class="flex items-center gap-1.5 text-[11px] text-muted-foreground/80 pt-2 border-t border-border/40"
        >
