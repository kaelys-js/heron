    ...
    <Card.Content class="p-5 space-y-4">
      ...
      <div class="flex items-stretch gap-4">
        {#if summary.score != null}
          <div
            class={cn(
              'flex flex-col items-center justify-center px-3.5 py-2 rounded-lg border min-w-[64px]',
              scoreClass,
            )}
          >
            <div class="text-2xl font-mono tabular-nums font-semibold leading-none">
