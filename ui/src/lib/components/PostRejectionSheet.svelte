  ...
  <Sheet.Content side="right" class="w-full sm:max-w-lg flex flex-col p-0 gap-0">
    <Sheet.Header class="px-5 pt-5 pb-3 border-b">
      <div class="flex items-start gap-3">
        <div class="size-9 rounded-lg bg-red-500/10 ring-1 ring-red-500/40 flex items-center justify-center flex-shrink-0">
    ...
    <div class="flex-1 overflow-y-auto px-5 py-4 space-y-4">
      <div class="space-y-1.5">
        ...
        />
        <p class="text-[10px] text-muted-foreground/70 leading-tight">Even a rejected app usually has SOMETHING you'd reuse — keep it for next time.</p>
      </div>
      ...
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          class="text-sm min-h-[72px]"
        />
        <p class="text-[10px] text-muted-foreground/70 leading-tight">Anything that wasn't in the JD or was different from your expectation.</p>
      </div>
      ...
      <div class="space-y-1.5">
        ...
        <Textarea
          ...
          class="text-sm min-h-[72px]"
        />
        <p class="text-[10px] text-muted-foreground/70 leading-tight">A specific lever you'd pull next time. Vague is OK; specific is better.</p>
      </div>
      ...
      <div class="rounded-md border border-border/40 bg-muted/30 px-3 py-2 flex items-start gap-2">
        ...
        <p class="text-[11px] text-muted-foreground/90 leading-relaxed">
          ...
          <code class="font-mono">contacto</code> read from this file so each app gets smarter.
          You can leave any field blank — Claude expands what it has.
        </p>
      </div>
    </div>
