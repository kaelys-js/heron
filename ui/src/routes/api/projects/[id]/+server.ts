...
export const GET = wrap('projects', async ({ params, url }: { params: { id: string }; url: URL }) => {
...
export const PUT = wrap('projects', async ({ params, request, url }: { params: { id: string }; request: Request; url: URL }) => {
...
export const DELETE = wrap('projects', async ({ params, url }: { params: { id: string }; url: URL }) => {
