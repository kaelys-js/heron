...
<div class="space-y-6">
  <header class="space-y-2">
    ...
    <p class="text-sm text-muted-foreground leading-relaxed max-w-xl">
      ...
      <em>you</em>, not the AI's default), and by the LinkedIn / Indeed scrapers (which need a
      location to focus search results). Nothing here is sent to any third party.
    </p>
  </header>
    ...
    <div class="space-y-3">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div>
          ...
          <Input
            id="province"
            bind:value={form.location_province}
            placeholder="BC"
            class="text-sm"
          />
        </div>
        <div>
          ...
          <Input
            id="country"
            bind:value={form.location_country}
            placeholder="Canada"
            class="text-sm"
          />
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <Input
            id="visa"
            bind:value={form.visa_status}
            placeholder="Canadian citizen, eligible to work in CA + US"
            class="text-sm"
          />
        </div>
      </div>
