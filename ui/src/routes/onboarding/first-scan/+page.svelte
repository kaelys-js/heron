...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between pt-4 border-t border-border/40">
    <a href="/onboarding/sources" class="text-xs text-muted-foreground hover:text-foreground inline-flex items-center gap-1">
    ...
    <div class="flex items-center gap-3">
      ...
      {/if}
      <Button onclick={() => continueOn('complete')} disabled={started && !finished} class="gap-1.5">
