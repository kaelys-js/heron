...
<div class="space-y-6">
  ...
  <section class="space-y-2">
    ...
    <div class="flex flex-wrap gap-1.5">
      {#each targetRoles as role, i (role + '-' + i)}
        <span
          class="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-rose-500/10 border border-rose-500/30 text-[11px]"
        >
          {role}
          <button
            type="button"
    ...
    <div class="flex gap-2">
      ...
      <Button
        variant="outline"
        size="sm"
        class="h-9 gap-1 flex-shrink-0"
        onclick={() => addChip('targetRoles')}
      >
  ...
  <section class="space-y-3">
    ...
    <p class="text-[11px] text-muted-foreground/80">
      Drives the Claude evaluation's hard-fit checks. Examples for must-have: "remote", "Series B+",
      "AI/ML focus". For hard-no: "on-site only", "below $120k", "≤20 person team".
    </p>
    ...
    <div class="space-y-1.5">
      ...
      <div class="flex gap-2">
        <Input
          bind:value={draft.mustHave}
          onkeydown={(e) => onKeyEnter(e, 'mustHave')}
          placeholder="remote, AI/ML focus"
          class="text-sm"
        />
        <Button
          variant="outline"
    ...
    <div class="space-y-1.5">
      ...
      <div class="flex gap-2">
        <Input
          bind:value={draft.strongPlus}
          onkeydown={(e) => onKeyEnter(e, 'strongPlus')}
          placeholder="founding team, equity heavy"
          class="text-sm"
        />
        <Button
          variant="outline"
    ...
    <div class="space-y-1.5">
      ...
      <div class="flex gap-2">
        <Input
          bind:value={draft.hardNo}
          onkeydown={(e) => onKeyEnter(e, 'hardNo')}
          placeholder="on-site only, below $120k"
          class="text-sm"
        />
        <Button
          variant="outline"
