  ...
  function applyCvSuggestion(suggestion: {
    ...
    if (suggestion.narrative) {
      ...
      next.narrative = {
        ...
        exit_story: cur.exit_story?.trim()
          ? cur.exit_story
          : (proposed.exit_story ?? cur.exit_story),
        superpowers:
    ...
    <div class="max-w-3xl mx-auto space-y-5">
      ...
      <div class="space-y-2">
        ...
        <p class="text-sm text-muted-foreground leading-relaxed">
          Everything the system knows about you. Every job evaluation, tailored CV PDF, cover
          letter, interview-prep brief, and offer-negotiation draft reads from this page. The more
          accurate and specific these fields are, the better the matching, scoring, and writing the
          AI does on your behalf.
        </p>
      ...
      {#if !data.profile.exists}
        ...
        >
          ...
          <div class="text-amber-200/90 leading-relaxed">
            ...
            — we'll create <code class="font-mono">config/profile.yml</code> on disk with your data and
            never write to it again unless you save more changes.
          </div>
        </div>
      {/if}
          ...
          {#each IDENTITY_FIELDS as f}
            <div class={cn('space-y-1.5', f.span === 2 && 'md:col-span-2')}>
              ...
              <ValidatedInput
                ...
                oninput={(e: Event) =>
                  patchCandidate({ [f.key]: (e.currentTarget as HTMLInputElement).value } as any)}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-1.5">
            ...
            {:else}
              <Input
                value={edit.location?.province ?? ''}
                oninput={(e: Event) =>
                  patchLocation({ province: (e.currentTarget as HTMLInputElement).value })}
          ...
          <div class="space-y-1.5">
            ...
            <Input
              ...
              oninput={(e: Event) =>
                patchLocation({ city: (e.currentTarget as HTMLInputElement).value })}
          ...
          <div class="space-y-1.5">
            ...
            <ChipListEditor
              ...
              onchange={(next: string[]) =>
                (edit = { ...edit, target_roles: { ...edit.target_roles, primary: next } })}
          ...
          {#if data.profile.archetypes.length > 0}
            <div class="space-y-1.5 pt-3 border-t border-border/40">
              ...
              <p class="text-[11px] text-muted-foreground leading-relaxed">
                ...
                fit score per archetype. Used by Claude during deep evaluation to decide which CV
                bullets to prioritize. This is structured YAML that's easier to edit by hand in <code
                  class="font-mono">config/profile.yml</code
                > for now.
              </p>
        ...
        <div class="space-y-4">
          <div class="space-y-1.5">
            ...
            <Input
              ...
              oninput={(e: Event) =>
                patchNarrative({ headline: (e.currentTarget as HTMLInputElement).value })}
          ...
          <div class="space-y-1.5 pt-2 border-t border-border/40">
            ...
            <p class="text-[11px] text-muted-foreground/70 leading-relaxed">
              3–6 concrete capabilities — skills, not adjectives. <em
                class="not-italic text-foreground/80">"Production TypeScript end-to-end"</em
              >
              works · <em class="not-italic text-muted-foreground/60">"strong communicator"</em> doesn't.
              These become bullet points on tailored CVs and highlight phrases in cover letters.
            </p>
            <ChipListEditor
          ...
          <div class="space-y-1.5 pt-2 border-t border-border/40">
            ...
            <p class="text-[11px] text-muted-foreground/70 leading-relaxed">
              Specific projects, articles, or wins with a metric. Each one becomes a citable bullet
              on tailored CVs and a reference in negotiation drafts ("at <em
                class="not-italic text-foreground/80">$company</em
              >, you led X with Y outcome — that's worth $Z").
            </p>
            <ProofPointEditor
              items={edit.narrative?.proof_points ?? []}
              onchange={(next: NonNullable<ProfileEdit['narrative']>['proof_points']) =>
                patchNarrative({ proof_points: next })}
        ...
        <div class="space-y-4">
          <div class="space-y-1.5">
            ...
            <ChipListEditor
              ...
              onchange={(next: string[]) =>
                (edit = { ...edit, preferences: { ...edit.preferences, must_have: next } })}
          ...
          <div class="space-y-1.5">
            ...
            <ChipListEditor
              ...
              onchange={(next: string[]) =>
                (edit = { ...edit, preferences: { ...edit.preferences, strong_plus: next } })}
          ...
          <div class="space-y-1.5">
            ...
            <ChipListEditor
              ...
              onchange={(next: string[]) =>
                (edit = { ...edit, preferences: { ...edit.preferences, hard_no: next } })}
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-start gap-3 rounded-md border border-border/40 bg-card px-3 py-3">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-muted-foreground/80 leading-relaxed mt-0.5">
                When ON, the autopilot drain submits applications without per-job confirmation —
                including the final Submit click. Read <a
                  href="/help/autonomous-apply"
                  class="underline underline-offset-2 hover:text-foreground"
                  >the risk acknowledgment</a
                > first.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <Input
                ...
                oninput={(e) => {
                  ...
                  edit = {
                    ...edit,
                    automation: { ...edit.automation, warmup_days: isFinite(v) ? v : 0 },
                  };
                }}
              />
              <p class="text-[10px] text-muted-foreground/70 leading-relaxed">
            ...
            <div class="space-y-1.5">
              ...
              <div class="grid grid-cols-2 gap-1.5">
                {#each [{ id: 'linkedin', label: 'LinkedIn', supported: true }, { id: 'greenhouse', label: 'Greenhouse', supported: true }, { id: 'ashby', label: 'Ashby', supported: true }, { id: 'lever', label: 'Lever', supported: true }, { id: 'workable', label: 'Workable', supported: true }, { id: 'personio', label: 'Personio (DACH)', supported: true }, { id: 'smartrecruiters', label: 'SmartRecruiters', supported: true }, { id: 'recruitee', label: 'Recruitee', supported: true }, { id: 'teamtailor', label: 'Teamtailor', supported: true }, { id: 'workday', label: 'Workday (heuristic — instance varies)', supported: true }, { id: 'indeed', label: 'Indeed (Easy Apply only)', supported: true }] as portal (portal.id)}
                  {@const enabled = (
                    edit.automation?.enabled_portals ?? ['linkedin', 'greenhouse', 'ashby']
                  ).includes(portal.id)}
                  <label class="flex items-center gap-2 text-[11px] cursor-pointer">
                    <input
                      ...
                      onchange={(e) => {
                        ...
                        const cur = edit.automation?.enabled_portals ?? [
                          'linkedin',
                          'greenhouse',
                          'ashby',
                        ];
                        ...
                        edit = {
                          ...edit,
                          automation: { ...edit.automation, enabled_portals: next },
                        };
                      }}
                    />
                    <span class={cn(!portal.supported && 'text-muted-foreground/50')}
                      >{portal.label}</span
                    >
                  </label>
                {/each}
          ...
          >
            ...
            <p class="text-[11px] text-amber-100/90 leading-relaxed">
              ...
              <a
                href="/help/autonomous-apply"
                class="underline underline-offset-2 hover:text-foreground">help page</a
              >
      ...
      >
        ...
        <div class="space-y-3">
          <div
            class="rounded-md border border-border/40 bg-card px-3 py-2.5 flex items-center gap-3 flex-wrap"
          >
            <span class="text-xs">
              {#if storyBankStats}
                <span class="font-mono">{storyBankStats.storyCount}</span>
                <span class="text-muted-foreground"
                  >{storyBankStats.storyCount === 1 ? 'story' : 'stories'} in bank</span
                >
              {:else}
            ...
            <Button onclick={seedStoryBank} disabled={seedingStoryBank} size="sm" class="gap-1.5">
              {#if seedingStoryBank}
                <Loader2 class="size-3 animate-spin" /> Seeding…
              {:else}
                <Sparkles class="size-3" />
                {storyBankStats && storyBankStats.storyCount > 0
                  ? 'Re-seed from CV'
                  : 'Seed from CV'}
              {/if}
            </Button>
          ...
          <p class="text-[11px] text-muted-foreground/80 leading-relaxed">
            ...
            and appends STAR+R stories to
            <code class="font-mono">interview-prep/story-bank.md</code>. Existing stories aren't
            overwritten — re-seeding only adds new ones from CV bullets that don't already have a
            story. Edit by hand to refine wording. ~30-60s per seed via Claude CLI.
          </p>
        </div>
      </CollapsibleCard>
          ...
          <div class="flex items-start gap-3 p-3 rounded-md border border-border/40 bg-card/50">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-muted-foreground mt-0.5 leading-relaxed">
                Your canonical CV in plain markdown. Every tailored PDF is generated from this file,
                every cover-letter draft references its experience section, every fit score reads
                ...
                <div class="flex items-center gap-1 mt-2.5 flex-wrap">
                  <Tooltip.Root>
                    ...
                    <Tooltip.Content side="bottom" class="text-xs"
                      >Read-only rendered markdown · copy or download as .md</Tooltip.Content
                    >
                  </Tooltip.Root>
                  ...
                  <Tooltip.Root>
                    ...
                    <Tooltip.Content side="bottom" class="text-xs"
                      >In-place edit · backs up previous version to cv.md.bak before saving</Tooltip.Content
                    >
                  </Tooltip.Root>
                    ...
                    <Tooltip.Trigger>
                      {#snippet child({ props })}
                        ...
                        >
                          ...
                          {data.profile.files.cv.exists ? 'Replace' : 'Add CV'}
                        </Button>
                      {/snippet}
                    </Tooltip.Trigger>
                  ...
                  <Tooltip.Root>
                    ...
                    <Tooltip.Content side="bottom" class="text-xs max-w-xs">
                      Run Claude over cv.md to extract identity + narrative + location into the
                      profile form. Costs ~$0.10–$0.30. Nothing saves until you click Save Profile.
                    </Tooltip.Content>
                  </Tooltip.Root>
                  ...
                  <Tooltip.Root>
                    ...
                    <Tooltip.Content side="bottom" class="text-xs"
                      >Copy the file path so you can open cv.md in your editor</Tooltip.Content
                    >
                  </Tooltip.Root>
                </div>
              </Tooltip.Provider>
          ...
          <div class="flex items-start gap-3 p-3 rounded-md border border-border/40 bg-card/50">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-muted-foreground mt-0.5 leading-relaxed">
                ...
                <code class="font-mono">cv.md</code> with <em>no</em> per-job rewriting, keeping it consistent
              ...
              <Tooltip.Provider delayDuration={300}>
                <div class="flex items-center gap-1 mt-2.5 flex-wrap">
                  <Tooltip.Root>
                    <Tooltip.Trigger>
                      {#snippet child({ props })}
                        <Button
                          ...
                          class={cn(
                            'h-7 text-xs gap-1.5',
                            (!generalCv.exists || generalCv.outdated) &&
                    ...
                    <Tooltip.Content side="bottom" class="text-xs max-w-xs">
                      Runs Claude over <code class="font-mono">cv.md</code> + the HTML template, then
                      renders the PDF via headless Chromium. Costs ~$0.30–$0.60. Takes ~15–30s.
                    </Tooltip.Content>
                  </Tooltip.Root>
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 flex-wrap">
                <span class="text-xs font-medium"
                  >Background-check policy &amp; narrative overrides (modes/_profile.md)</span
                >
              ...
              <p class="text-[11px] text-muted-foreground mt-0.5 leading-relaxed">
                Your overrides for the system layer: background-check disclosure rules,
                archetype-mapping tweaks, language preferences for evaluation reports. The default
            ...
            <div class="flex-1 min-w-0 space-y-1.5">
              ...
              >
                ...
                <li>
                  ...
                  activity feed.
                  <em>Profile, CV, targeting, and connected sources are preserved</em> so you can keep
                  working.
                </li>
                <li>
      ...
      <CvManagerSheet
        ...
        onApplySuggestion={applyCvSuggestion}
      />
      <ResetProfileDialog
        bind:open={resetOpen}
        initialScope={resetInitialScope}
        profileId={data.profileId}
      />
    </div>
  </div>
