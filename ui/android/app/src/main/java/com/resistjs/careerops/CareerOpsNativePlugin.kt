// Android counterpart of iOS CareerOpsNativePlugin.swift.
//
// Capacitor plugin that exposes Android-native features to the WebView
// via the same JS API surface — registerPlugin<CareerOpsNativePlugin>
...
@CapacitorPlugin(name = "CareerOpsNative")
class CareerOpsNativePlugin : Plugin() {

    companion object {
        @Volatile var instance: CareerOpsNativePlugin? = null
    ...
    override fun load() {
        ...
        networkMonitor = NetworkMonitor(context.applicationContext).also { m ->
