...
4. **Generate a message** with a 3-sentence framework tailored to the contact type:
   ...
   - **Sentence 2 (Proof)**: The candidate's largest quantifiable win that shows they've solved similar problems
...
5. **Versions**:
   - EN (default)
   - Localized variant (if the company is non-English-speaking)

6. **Alternate targets** with justification of why they're good second choices.
