...
- If FDE → prioritize fast-delivery + client-facing proof points
- If SA → prioritize systems design + integrations
- If PM → prioritize product discovery + metrics
...
Save the full evaluation to `__REPORTS__/{###}-{company-slug}-{YYYY-MM-DD}.md`.
...
**ALWAYS** record in `data/__APPLICATIONS__`:
