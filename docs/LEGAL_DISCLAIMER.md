...
Heron interacts with career portals and job boards (Greenhouse, Lever, Ashby, Workday, and others).
...
Heron is designed to help individuals make better career decisions, not to automate away human judgment. Acceptable use includes:
...
The "heron" name and brand identity are separate from the MIT
