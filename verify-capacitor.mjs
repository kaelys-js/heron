...
contains('lefthook.yml', 'typecheck', 'pre-commit + pre-push typecheck (svelte-check + tsgo)');
contains('lefthook.yml', 'verify:cached', 'pre-push runs all verifiers via turbo cache');
