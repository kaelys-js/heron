...
> The visual color system for Heron. Strategy + voice live in
> [`BRAND.md`](./BRAND.md); typography in [`TYPOGRAPHY.md`](./TYPOGRAPHY.md).
> The runtime/build source of truth is the `colors` block in
> [`brand.json`](./brand.json) -- a rebrand edits that, runs
> `pnpm brand:apply`, and the CSS/Tailwind layer derives every token
> below from those base values.
...
| `--accent-strong` | `#c89b4a` |
| `--accent-secondary` | `#7a8c6d` |
| `--accent-secondary-foreground` | `#0e1014` |
| `--accent-secondary-strong` | `#9aab8c` |
| `--destructive` | `#e0686f` |
| `--destructive-foreground` | `#14181f` |
| `--success` | `#5fcf80` |
| `--success-foreground` | `#0e1014` |
| `--warning` | `#e6b53f` |
| `--warning-foreground` | `#0e1014` |
| `--info` | `#5aa9e6` |
| `--info-foreground` | `#0e1014` |
| `--border` | `#232a35` |
| `--input` | `#5d6775` |
| `--ring` | `#c89b4a` |
| `--sidebar` | `#0e1014` |
